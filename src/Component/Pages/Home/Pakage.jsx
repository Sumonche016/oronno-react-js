  ...
  const renderPackage = (items, title, price, discount, isPlants = true) => (
    <motion.div
      ...
      className={`w-full lg:w-1/2 p-4 ${
        isPlants ? "lg:border-r-2 lg:border-green-200" : ""
      }`}
    >
      <div className="relative">
        <div className="absolute -top-4 -right-4 bg-red-500 text-white px-4 py-2 rounded-lg shadow-lg flex items-center gap-2">
        ...
        <div className="text-center mb-8">
          ...
          <motion.div
            ...
            className="bg-gradient-to-r from-green-500 to-green-700 text-white p-4 rounded-lg shadow-xl mb-4"
          >
            <h3 className="text-2xl font-bold">
              {isPlants
                ? "পট সহ ৫ টি প্রিমিয়াম ইনডোর প্লান্ট মাত্র"
          ...
          {items.map((item, index) => (
            ...
            >
              ...
              <div className="p-3 bg-white">
                ...
                {!isPlants && (
                  <p className="text-green-600 font-bold">কলমের গাছ</p>
                )}
                {isPlants && <p className="text-green-600">৫'' পট সহ</p>}
              </div>
            </motion.div>
          ))}
        </div>
        ...
        >
          <button className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-full text-lg font-semibold shadow-lg transform transition-all duration-300 flex items-center justify-center gap-2 mx-auto">
            <FaShoppingCart />
    ...
    <div className="py-12 px-4 bg-gradient-to-b from-green-50 to-white">
      <div className=" mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          {renderPackage(
            plants,
            "প্রিমিয়াম ইনডোর প্লান্ট প্যাকেজ",
            "৳499",
            "৳999",
            true
          )}
